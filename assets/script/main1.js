...
function init_carousel_posts(){
  if(!jQuery('.carousel-posts__inner').length){
    return false;
  }

   var owl = jQuery('.carousel-posts__inner.owl-carousel');
  ...
  _owl.on('initialized.owl.carousel', function(e){
    _owl.siblings('.carousel-posts__ctrl').removeClass('visuallyhidden');
  })

    _owl.owlCarousel(args);

    _owl.siblings('.carousel-posts__ctrl').find('.prev').click(function(){
      _owl.trigger('prev.owl.carousel');
    })

    _owl.siblings('.carousel-posts__ctrl').find('.next').click(function(){
      _owl.trigger('next.owl.carousel');
    })
  });
}

function init_carousel_1(){
  if(!jQuery('.carousel-global .order-links-carousel').length){
    return false;
  }
   var owl = jQuery('.owl-carousel.order-links-carousel');
  ...
  _owl.on('initialized.owl.carousel', function(e){
    jQuery('.carousel-ctrl ').removeClass('visuallyhidden');
  })
...
jQuery('.to-top-tower').click(function(event) {
...
jQuery(document).ready(function(){
  ...
  jQuery('.equal-height-parent').each(function(index, el) {
    var childs = jQuery(el).find('.equal-height');

    var height = -1;
    childs.each(function(_index, _el) {
      height = Math.max(height, jQuery(_el).height())
    });
