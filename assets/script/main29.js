        ...
        jQuery(vm.$el).daterangepicker({
          ...
          // "endDate": date_end,
           ...
           isInvalidDate: function(date){
             // 3  декабря  - 3 апреля - работает
             // 25 июня - 5 сентября - работает

             // 4 апреля до 24 июня не рабоает
             // 6 сентября  до 2 декабря не рабоает

             var year = date.year();

             var start1 = year+'-04-04';
             var start2 = year+'-09-06';
             ...
             return (current_date > start1 && current_date < end1) || (current_date > start2 && current_date < end2);
           },
